...
def run_model():
    with tf.device('/gpu:0'):
        ...
        model_keys = ['liver_lobes', 'liver', 'liver_3d', 'liver_3df', 'lungs', 'liver_disease', 'lacc', 'lacc_3d', 'pancreas',
...
def run_model_single(input_path, output_path, model_key):
    with tf.device('/gpu:0'):
        ...
        model_list = ['liver', 'liver_3d', 'liver_3df', 'lungs', 'liver_lobes', 'liver_disease', 'lacc', 'lacc_3d', 'pancreas', 'ctvn',
