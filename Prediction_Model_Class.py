...
def run_model():
    with tf.device('/gpu:0'):
        models_info = {
            ...
            'lung_gtv': return_lung_gtv_model(),
        ...
        model_keys = ['liver_lobes', 'liver', 'liver_3d', 'liver_3df', 'lungs', 'lung_gtv', 'liver_disease', 'lacc',
                      'lacc_3d', 'pancreas',
...
def run_model_single(input_path, output_path, model_key):
    with tf.device('/gpu:0'):
        ...
        model_list = ['liver', 'liver_3d', 'liver_3df', 'lungs', 'lung_gtv_64', 'lung_gtv_96', 'lung_gtv_128',
